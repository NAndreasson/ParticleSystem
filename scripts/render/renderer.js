define(['render/gl-matrix'], function(glMatrix) {
  ...
  function renderer(canvasId, vShaderId, fShaderId) {
    ...
    if (!this.gl) {
      ...
      // get shaders
      initShaders.call(this, this.program, vShaderId, fShaderId);
      ...
      this.particleTexture = loadTexture.call(this, particleTextureData);
    }
  ...
  function draw() {
    ...
    glMatrix.mat4.perspective(45, this.gl.viewportWidth / this.gl.viewportHeight, 0.1, 100.0, this.pMatrix);
    glMatrix.mat4.identity(this.mvMatrix);

    var resolution = this.gl.getUniformLocation(this.program, "u_resolution");
    this.gl.uniform2f(resolution, 800, 600);
